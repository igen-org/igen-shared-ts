 ...
 */
export const modifyDate = (value, unit, date = now()) => shiftDate(date, value, unit);
/**
 * Calculates the difference between two dates in the desired unit.
 */
export const dateDiff = (start, end, unit) => {
 ...
 */
export const startOf = (date, unit, options) => {
 ...
 * @param options When `utc` is true calculations ignore the local timezone offset.
 */
export const endOf = (date, unit, options) => {
    if (unit === 'millisecond') {
 ...
 * @param options When `utc` is true calculations ignore the local timezone offset.
 */
export const isSame = (a, b, unit, options) => {
